  ...
  >
    ...
    >
      ...
      <span
        ...
        "
      >
        <template v-if="step === 2 && username"
          >如需继续操作，请先验证您的身份</template
        >
      ...
      >
        ...
        <form
          ...
          class="slide-form"
          :class="{
            'slide-in-right': step === 2,
            'slide-out-right': step === 1,
          }"
          style="position: absolute; width: 100%"
        >
          <mdui-text-field
